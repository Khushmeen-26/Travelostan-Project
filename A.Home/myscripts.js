...
function fL(){
            var
            name=document.getElementById("iL").value;
            var np=/(^[A-Z]{1}[a-z]+$|^[A-Z]{1}[az]+\s{1}[A-Z]{1}[a-z]+$)/;
            if(np.test(name)){
            document.getElementById("tL").style.color="Green";
            document.getElementById("tL").innerHTML="Correct";
            }
            else{
            document.getElementById("tL").style.color="Black";
            document.getElementById("tL").innerHTML="Incorrect";
            }
            }
function f1L(){
            var
            ...
            document.getElementById("tL").innerHTML="Fields With * Can't Be Left Empty!!";
            }
            }
function f2(){
            var
            mobile=document.getElementById("i2").value;
            var mp=/^[0-9]{10}$/;
            if(mp.test(mobile)){
...
function f4(){
            var
            password=document.getElementById("i4").value;
            var p1=/[A-Z]+/;
            var p2=/[a-z]+/;
            var p3=/[0-9]+/;
            var p4=/[!@#$%^&*]/;
...
function f5(){
            var
            confirmpass=document.getElementById("i5").value;
            var
            password=document.getElementById("i4").value;
...
function f6(){
            var
            v1=document.getElementById("t1").innerHTML;
            var
            v2=document.getElementById("t2").innerHTML;
            var
            v3=document.getElementById("t3").innerHTML;
            var
            v4=document.getElementById("t4").innerHTML;
            var
            v5=document.getElementById("t5").innerHTML;
            var v6="Correct";
...
function check(){
    ...
    if(name=="Shimla"){
        document.getElementById("link").href="file:///D:/travelostan%202.o/travelosatn1/travelostan%20-%20PAnge%20pado9/B.Shimla/shimla.html";
        document.getElementById("link").target = "_blank";
        
    }
    else if(name==""){
         document.getElementById("msg").innerHTML="Please enter your destination"
    }
    else if(name=="Varanasi"){
        document.getElementById("link").href="file:///D:/travelostan%202.o/travelosatn1/travelostan%20-%20PAnge%20pado9/C.Varanasi/varanasi.html";
        document.getElementById("link").target = "_blank";
        
    }
    else{
        document.getElementById("msg").innerHTML="Invalid Destination!!"
